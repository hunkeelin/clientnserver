...
var (
	...
	validFor   = flag.Duration("duration", 7200*24*time.Hour, "Duration that certificate is valid for")
...
func genCrt(certpath, keypath string) {
	h, err := os.Hostname()
	if err != nil {
		log.Fatal(err)
	}
